...
//parsing and validating a port string into an integer in range [1, 65535]
//returning 0 on success, -1 on invalid input
...
//reading server-selected port from hint file created by server startup
//returning 0 on success, -1 if file is missing/invalid
